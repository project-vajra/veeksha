...
lint/codespell:
	codespell --skip './env/**,./docs/_build/**,./veeksha.egg-info/**,./test_output/**,./benchmark_results/**,./build/**,./wandb/**,./veeksha/evaluator/performance/asr_normalizer/english_abbreviations.py' -L inout
