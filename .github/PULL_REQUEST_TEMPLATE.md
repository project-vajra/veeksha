...
<p>Thank you for your contribution to Veeksha! Before submitting the pull request, please ensure the PR meets the following criteria. This helps Veeksha maintain the code quality and improve the efficiency of the review process.</p>
...
<ul>
    ...
    <li><code>[Core]</code> for changes in the core benchmarking logic </li>
    <li><code>[CI/Build]</code> for build or continuous integration improvements.</li>
    <li><code>[Docs]</code> for documentation fixes and improvements.</li>
    <li><code>[Tests]</code> for changes in the test suite.</li>
...
<p> Finally, thank you for taking the time to read these guidelines and for your interest in contributing to Veeksha. Your contributions make Veeksha a great tool for everyone! </p>
