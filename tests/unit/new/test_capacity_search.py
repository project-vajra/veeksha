...
from veeksha.new.capacity_search import (
...
from veeksha.new.config.capacity_search import CapacitySearchConfig
...
@pytest.mark.unit
@patch("veeksha.new.capacity_search._read_slo_results")
@patch("veeksha.new.capacity_search.manage_benchmark_run")
@patch("veeksha.new.capacity_search._init_capacity_search_output_dir")
