Capacity Search Configuration
=============================

Configuration reference for ``veeksha.capacity_search`` runs.
...
.. code-block:: yaml
    ...
    capacity_search_config:
      output_dir: <str>  # default: 'capacity_search_output'
...
``benchmark_config.session_generator.session_graph``
""""""""""""""""""""""""""""""""""""""""""""""""""""
...
``benchmark_config.session_generator.session_graph.num_request_generator``
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
``benchmark_config.session_generator.session_graph.request_wait_generator``
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
``benchmark_config.session_generator.channels``
"""""""""""""""""""""""""""""""""""""""""""""""
...
``benchmark_config.session_generator.channels.body_length_generator``
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
``benchmark_config.session_generator.channels.output_length_generator``
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
``benchmark_config.session_generator.flavor``
"""""""""""""""""""""""""""""""""""""""""""""
...
``benchmark_config.traffic_scheduler``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``benchmark_config.traffic_scheduler.interval_generator``
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
``benchmark_config.evaluators.slos``
""""""""""""""""""""""""""""""""""""
...
``benchmark_config.evaluators.text_channel``
""""""""""""""""""""""""""""""""""""""""""""
...
``benchmark_config.evaluators.text_channel.decode_window_config``
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
