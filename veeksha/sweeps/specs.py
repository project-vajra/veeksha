...
SPECS: Dict[Tuple[str, str, str], SweepSpec] = {
    ...
    (CONCURRENCY_SWEEP, "sglang", "higgs-audio-v3"): SweepSpec(
        sweep_type=CONCURRENCY_SWEEP,
        engine="sglang",
        model="higgs-audio-v3",
        config_name="sglang_higgs_audio_v3.yaml",
        temp_prefix="sglang_higgs_audio_v3_sweep",
        run_config_template="sglang_higgs_audio_v3_c{concurrency}.yaml",
        run_name_template="sglang_higgs_audio_v3_c_{concurrency}_10_minutes",
    ...
    (CONCURRENCY_SWEEP, "vajra", "higgs-audio-v3"): SweepSpec(
        sweep_type=CONCURRENCY_SWEEP,
        engine="vajra",
        model="higgs-audio-v3",
        config_name="vajra_higgs_audio_v3.yaml",
        temp_prefix="vajra_higgs_audio_v3_sweep",
        run_config_template="vajra_higgs_audio_v3_c{concurrency}.yaml",
        run_name_template="vajra_higgs_audio_v3_c_{concurrency}_10_minutes",
        default_concurrencies=(1, 2, 4, 8, 16, 32, 64),
    ),
