...
class SessionGenerator:
    ...
    def generate_sessions(self, requests_df: pd.DataFrame) -> pd.DataFrame:
        ...
        _log_session_dispatch_diagnostics(sampled_requests)
...
def _log_session_dispatch_diagnostics(sampled_requests: List[Dict[str, Any]]) -> None:
    """Log session dispatch rate diagnostics for a generated trace.

    - overall session dispatch rate
    - inter-arrival statistics
    - rate over equal-sized time chunks
