...
from veeksha.new.types import TraceFlavorType
...
TraceFlavorGeneratorRegistry.register(
    ...
    _LazyLoader(
        "veeksha.new.generator.session.trace.claude_code",
...
TraceFlavorGeneratorRegistry.register(
    ...
    _LazyLoader(
        "veeksha.new.generator.session.trace.mooncake_conv",
...
TraceFlavorGeneratorRegistry.register(
    TraceFlavorType.RAG,
    _LazyLoader(
        "veeksha.new.generator.session.trace.rag",
